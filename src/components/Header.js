        ...
        return (
            <div style={{height: "70px"}}>
                ...
                <div className={this.state.menuClassName}>
                    ...
                    <div><a className="nav-link" href="https://drive.google.com/file/d/1yAD_ntqAadDQ_ACqsw8R9A91w6XcIyg0/view?usp=sharing" target="_blank" rel="noopener noreferrer"><span role="img" aria-label="briefcase">💼</span> Resume</a></div>
