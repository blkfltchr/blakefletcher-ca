...
const Mighty = () => (
    ...
    <StaticQuery 
        ...
        render={
            data => (
                <div>
                    <Img style={{width: "60vw"}} sizes={data.file.childImageSharp.sizes} alt="mighty jumbo"/>
                    <h4 style={{fontFamily: "Lato,Helvetica,Arial,Lucida,sans-serif", fontSize: "1.4rem"}}>Mighty Records</h4>
