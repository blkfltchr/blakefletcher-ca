...
const Mighty = () => (
    ...
    <StaticQuery
        ...
        render={
            data => (
                <div className="exp">
                    <a href="http://mightyrecords.ca/" target="_blank" rel="noopener noreferrer"><Img className="experience-img" sizes={data.file.childImageSharp.sizes} alt="mighty jumbo"/>
                    <h4>Mighty Records</h4></a>
