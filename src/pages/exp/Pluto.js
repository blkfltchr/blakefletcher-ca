        ...
        render={
            data => (
                <div>
                    ...
                    <h4 style={{fontFamily: "Lato,Helvetica,Arial,Lucida,sans-serif", fontSize: "1.4rem"}}>Pluto (<a href="https://talkpluto.com/" target="_blank" rel="noopener noreferrer" style={{color: "blue"}}>view site</a>)</h4>
                    ...
                    <p style={{fontFamily: "Merriweather,Georgia,Times New Roman,serif", fontSize: "1.1rem", fontStyle: "italic", textAlign: "center"}}>Co-Founder, August 2016-April 2018</p>
                </div>
            )
        }
    />
