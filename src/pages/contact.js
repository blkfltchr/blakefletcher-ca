            ...
            <form name="contact" method="post" action="/success" data-netlify="true" data-netlify-honeypot="bot-field">
                ...
                <div style={{display: "flex", justifyContent: "center"}}>
                    <div style={{display: "flex", flexDirection: "column", alignItems: "flex-start"}}>
                        ...
                        <input style={{width: "30vw", margin: "0.5rem", padding: "1rem", border: "solid 1px lightgrey", borderRadius: "1rem", fontFamily: "Merriweather, Georgia, Times New Roman, serif", fontSize: "1.4rem"}} type="text" name="name" id="name" required/>
                    </div>
                    <div style={{display: "flex", flexDirection: "column", alignItems: "flex-start"}}>
                        ...
                        <input style={{width: "30vw", margin: "0.5rem", padding: "1rem", border: "solid 1px lightgrey", borderRadius: "1rem", fontFamily: "Merriweather, Georgia, Times New Roman, serif", fontSize: "1.4rem"}} type="text" name="email" id="email" required/>
                    </div>
                </div>
                <div style={{display: "flex", flexDirection: "column", alignItems: "flex-start"}}>
                    ...
                    <textarea style={{width: "63vw", margin: "0.5rem", padding: "1rem", border: "solid 1px lightgrey", borderRadius: "1rem", fontFamily: "Merriweather, Georgia, Times New Roman, serif", fontSize: "1.4rem"}} name="message" id="message" rows="6" required></textarea>
                </div>
                <div>
