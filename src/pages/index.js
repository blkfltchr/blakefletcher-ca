    ...
    return (
        <div>
            ...
            <div className="page-wrapper">
                ...
                <p className="homepage-paragraph">Currently, I live in Toronto and work as a Software Engineer at <a className="nav-link" href="https://inkblottherapy.com/" target="_blank" rel="noopener noreferrer">Inkblot</a>. On the side, I've started<a className="nav-link" href="https://citylovesupply.com/" target="_blank" rel="noopener noreferrer">City Love Supply Co.</a>, a T-shirt line that's by and for creatives.</p>
