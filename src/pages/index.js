    ...
    return ( 
        <div>
            ...
            <div className="page-wrapper">
                ...
                <p className="homepage-paragraph">Currently, I live in Toronto, where I'm studying computer science at <Link to="/experience">Lambda School</Link>, and completing my capstone project, <a href="https://github.com/labs11-library" target="_blank" rel="noopener noreferrer">Book Maps</a>, a web app that helps neighbours share their book collections.</p>
