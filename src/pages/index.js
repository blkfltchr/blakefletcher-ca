    ...
    return ( 
        <div>
            ...
            <div style={{margin: "2.5rem auto 0 auto", width: "75vw", height: "100%", display: "flex", flexDirection: "column", textAlign: "center"}}>
                ...
                <p style={{fontFamily: "Merriweather,Georgia,Times New Roman,serif", fontSize: "1.5rem"}}>At the beginning of 2016, I made a move. I’ve kept moving ever since. Currently, I live in Toronto and work as a Project Manager for <a href="https://lambdaschool.com/" target="_blank" rel="noopener noreferrer" style={{color: "blue"}}>Lambda School</a>, helping graduates get the best jobs they've ever had. Music is my first love. I spend my time building web apps, writing to think clearer, and interacting with people, places and things that I can learn from.</p>
