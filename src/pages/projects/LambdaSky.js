            ...
            data => (
                <div className="project-card-wrapper">
                    ...
                    <div className="project-content">
                        ...
                        <p className="left-paragraph">A travel app built with a team of 8. It allows users to book trips (hotels, car rentals, flights, and other activities.). With other backend devs, we built out a database, payment method, authentication, and authorization using OAuth, Stripe, MongoDB and more.</p>
                        <div>
