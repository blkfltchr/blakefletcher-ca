            ...
            <div style={{margin: "0 auto", height: "100%", textAlign: "center"}}>
                ...
                <div style={{display: "flex", justifyContent: "space-evenly"}}>
                    <div style={{width: "500px", margin: "0.5rem", padding: "0.5rem 0", border: "solid 1px lightgrey", borderRadius: "1.5rem"}}>
                        <img src={howtolearnreact} alt="howtolearnreact logo"/>
                        <div style={{textAlign: "center"}}>
                            <h4 style={{fontFamily: "Lato,Helvetica,Arial,Lucida,sans-serif", fontSize: "1.5rem"}}>How To Learn React</h4>
                            <p style={{fontFamily: "Merriweather,Georgia,Times New Roman,serif", fontSize: "1.2rem", textAlign: "center"}}>A project intended to share the things I learn while working with React. As I build things, complete tutorials, read articles, and watch videos, I add to the blog.</p>
                            <div>
